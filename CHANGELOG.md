...
* use Cloud fallback pair when Cursor overrides env ([#57](https://github.com/jurislm/coolify-plugin/issues/57)) ([586d0f2](https://github.com/jurislm/coolify-plugin/commit/586d0f21add885ca664c73d93804adbeca67bf24))
...
* **cursor:** isolate GitHub plugin from Codex MCP config ([#53](https://github.com/jurislm/coolify-plugin/issues/53)) ([33a1590](https://github.com/jurislm/coolify-plugin/commit/33a15906c40a7b236fdff0ba8da4acbe01774233))
...
* align local Coolify plugin metadata (JUR-329) ([c24259a](https://github.com/jurislm/coolify-plugin/commit/c24259ac4e44990909a8049fdf4d733d0f5b6b6b))
* align local Coolify plugin tool metadata (JUR-329) ([22a9160](https://github.com/jurislm/coolify-plugin/commit/22a916068bd71d149a85876226dc455aa129f548))
* keep Coolify tool titles distinct (JUR-329) ([ba1ce18](https://github.com/jurislm/coolify-plugin/commit/ba1ce1821ececa5396c029548669d62ec0fbdfcf))

## [4.0.12](https://github.com/jurislm/coolify-plugin/compare/v4.0.11...v4.0.12) (2026-09-25)


### Bug Fixes

* route private key updates by UUID (JUR-327) ([#45](https://github.com/jurislm/coolify-plugin/issues/45)) ([3261636](https://github.com/jurislm/coolify-plugin/commit/3261636c4d2eb1962a28df825681ce271f71fbfe))

## [4.0.11](https://github.com/jurislm/coolify-plugin/compare/v4.0.10...v4.0.11) (2026-09-25)


### Bug Fixes

* accept null application ports (JUR-326) ([#43](https://github.com/jurislm/coolify-plugin/issues/43)) ([08af078](https://github.com/jurislm/coolify-plugin/commit/08af078df5512b28fd06769aecf8729a43e2a9c7))

## [4.0.10](https://github.com/jurislm/coolify-plugin/compare/v4.0.9...v4.0.10) (2026-09-25)


### Bug Fixes

* accept null deployment commit messages (JUR-325) ([#41](https://github.com/jurislm/coolify-plugin/issues/41)) ([e953f9e](https://github.com/jurislm/coolify-plugin/commit/e953f9e8e6bb1a31c462aa98e8a6332f523f49f6))

## [4.0.9](https://github.com/jurislm/coolify-plugin/compare/v4.0.8...v4.0.9) (2026-09-25)


### Bug Fixes

* align Coolify plugin contracts with Coolify v4.3.23 ([#39](https://github.com/jurislm/coolify-plugin/issues/39)) ([4a32262](https://github.com/jurislm/coolify-plugin/commit/4a32262e5f4540b5dd76857c01007e81004e0028))

## [4.0.8](https://github.com/jurislm/coolify-plugin/compare/v4.0.7...v4.0.8) (2026-09-25)


### Bug Fixes

* align Coolify tag and backup write responses ([33fa876](https://github.com/jurislm/coolify-plugin/commit/33fa876143440c8a9d9b838c2d297662e4fb70ef))

## [4.0.7](https://github.com/jurislm/coolify-plugin/compare/v4.0.6...v4.0.7) (2026-09-25)


### Bug Fixes

* accept Coolify cloud-init detail response ([b3fbb26](https://github.com/jurislm/coolify-plugin/commit/b3fbb264c8f2d497bc6cf43b87f3dd6047c8cfb3))
...
* forward Coolify credentials to Codex MCP ([d480e19](https://github.com/jurislm/coolify-plugin/commit/d480e19c6ebe80c69fe8b0991e58af5841e7f866))

## [4.0.4](https://github.com/jurislm/coolify-plugin/compare/v4.0.3...v4.0.4) (2026-09-25)


### Bug Fixes

* align Coolify plugin with Coolify 4.3.23 ([73d8cab](https://github.com/jurislm/coolify-plugin/commit/73d8cabb2f6cb96bc52c3db6191f9c63c95b6ab9))

## [4.0.3](https://github.com/jurislm/coolify-plugin/compare/v4.0.2...v4.0.3) (2026-09-24)


### Bug Fixes

* display the Coolify logo in Cursor ([4c20a53](https://github.com/jurislm/coolify-plugin/commit/4c20a5353fac8f72127fcd9bf0d111ef617cfe23))

## [4.0.2](https://github.com/jurislm/coolify-plugin/compare/v4.0.1...v4.0.2) (2026-09-24)


### Bug Fixes

* import and configure Coolify in Cursor ([3b50408](https://github.com/jurislm/coolify-plugin/commit/3b50408488f0768b9d02bd8e3d5d71005cd5162f))

## [4.0.1](https://github.com/jurislm/coolify-plugin/compare/v4.0.0...v4.0.1) (2026-09-23)


### Bug Fixes

* publish Coolify package with npm ([926a64b](https://github.com/jurislm/coolify-plugin/commit/926a64b77a02f371b26c9698ab2d22424fd954eb))
* publish Coolify package with npm ([16023ca](https://github.com/jurislm/coolify-plugin/commit/16023cae90281125dc0992be17ff93ed2ae60da4))

## [4.0.0](https://github.com/jurislm/coolify-plugin/compare/v3.7.11...v4.0.0) (2026-09-23)


### ⚠ BREAKING CHANGES

* COOLIFY_URL and COOLIFY_TOKEN are no longer accepted; use COOLIFY_BASE_URL and COOLIFY_ACCESS_TOKEN.

### Features

* align Coolify plugin with current API contract ([0059f61](https://github.com/jurislm/coolify-plugin/commit/0059f6185028d2b129400f7ba0c18bd3f1071e8e))

## [3.7.11](https://github.com/jurislm/coolify-plugin/compare/v3.7.10...v3.7.11) (2026-09-21)


### Bug Fixes

* register tools before credential checks ([5dd249d](https://github.com/jurislm/coolify-plugin/commit/5dd249d49701575c4f94e3e3af56967033a8358d))
* register tools before credential checks ([#18](https://github.com/jurislm/coolify-plugin/issues/18)) ([76804e3](https://github.com/jurislm/coolify-plugin/commit/76804e39e7970912d27888c003f1fda080022c8e))
...
* use a provider-owned marketplace name ([175aeb2](https://github.com/jurislm/coolify-plugin/commit/175aeb21cb872d18a34a14214cb2407d87eb1aa0))
* use a provider-owned marketplace name ([#14](https://github.com/jurislm/coolify-plugin/issues/14)) ([1816dad](https://github.com/jurislm/coolify-plugin/commit/1816dad434b28cb8a243869e08763f4575b0ba73))

## [3.7.8](https://github.com/jurislm/coolify-plugin/compare/v3.7.7...v3.7.8) (2026-09-21)


### Bug Fixes

* expose root MCP registration ([#12](https://github.com/jurislm/coolify-plugin/issues/12)) ([a33460b](https://github.com/jurislm/coolify-plugin/commit/a33460bd3824564eace2d221037293e33686061e))

## [3.7.7](https://github.com/jurislm/coolify-plugin/compare/v3.7.6...v3.7.7) (2026-09-21)


### Bug Fixes

* support database custom Docker options ([#10](https://github.com/jurislm/coolify-plugin/issues/10)) ([f0308f1](https://github.com/jurislm/coolify-plugin/commit/f0308f1938d25e915f76bc2e0ffc4a5ffa45675a))

## [3.7.6](https://github.com/jurislm/coolify-plugin/compare/v3.7.5...v3.7.6) (2026-09-20)


### Bug Fixes

* include Plugin in Coolify display names ([#8](https://github.com/jurislm/coolify-plugin/issues/8)) ([695d708](https://github.com/jurislm/coolify-plugin/commit/695d7088cdb49e1df74581f8519310002a7ab3c2))

## [3.7.5](https://github.com/jurislm/coolify-plugin/compare/v3.7.4...v3.7.5) (2026-09-18)


### Bug Fixes

* add portable Coolify starter prompt ([1e7f79b](https://github.com/jurislm/coolify-plugin/commit/1e7f79ba85d0734cdec12577b46c7fe928967638))
...
* add plugin icons ([888c9e2](https://github.com/jurislm/coolify-plugin/commit/888c9e29e97d0b8c8d5a97458b11976eb58b69ce))
...
* add docker_compose_domains support for docker-compose app FQDN updates ([f3d0b44](https://github.com/jurislm/coolify-mcp/commit/f3d0b44b14a6262bdb9fe8d8fbf6d5ace0e3b219))
* add docker_compose_domains support for docker-compose app FQDN updates ([d9503b5](https://github.com/jurislm/coolify-mcp/commit/d9503b50165ffae6bd868c77a10a81247b7f6e58)), closes [#36](https://github.com/jurislm/coolify-mcp/issues/36)
...
- Tool count increased from 43 to 44

### Fixed

- Align `ServerDiagnostic.validation` type with `ServerValidation` (adds `valid?: boolean`)
...
* add build to prepublishOnly and include Claude Bot review fixes ([#18](https://github.com/jurislm/coolify-mcp/issues/18)) ([16e4246](https://github.com/jurislm/coolify-mcp/commit/16e424672a27f54b002c40c4f5373822b0d0084f))
